...
AC_ARG_WITH(boxtype,
	...
	[case "${withval}" in
		...
		hl101)
			...
			BOXMODEL="$withval"
		;;
		hd51|hd60|hd61|bre2ze4k|vusolo4k|vuduo4k|vuultimo4k|vuzero4k|vuuno4kse)
			BOXTYPE="armbox"
			BOXMODEL="$withval"
		;;
		vuduo)
...
AS_HELP_STRING([], [valid for armbox: hd51, hd60, hd61, bre2ze4k, vusolo4k, vuduo4k, vuultimo4k, vuzero4k, vuuno4kse])
